        ...
        <div className="grid gap-12 md:grid-cols-2 items-center">
          <div>
            ...
            <p className="text-lg text-muted-foreground mb-6">
              ...
              help you get started with your landing page.
            </p>
            <div className="space-y-4">
              <div className="flex items-center gap-3">
                <div className="flex-shrink-0 p-1.5 rounded-full bg-primary/10 text-primary">
                  <svg
                ...
                <div>
                  ...
                  <div className="text-muted-foreground">info@tusta.com</div>
                </div>
              </div>
              <div className="flex items-center gap-3">
                <div className="flex-shrink-0 p-1.5 rounded-full bg-primary/10 text-primary">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="text-muted-foreground">
                    123 Tech Plaza, San Francisco, CA
                  </div>
                </div>
              </div>
            </div>
